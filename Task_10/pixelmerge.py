...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Stitch together fragmented images.")
    parser.add_argument('input', type=str, nargs='?', default='fragments', help="Input folder containing image fragments.")
    parser.add_argument('output', type=str, nargs='?', default='stitched_image.png', help="Output file path for the stitched image.")
    args = parser.parse_args()

    stitch_images(args.input, args.output)
